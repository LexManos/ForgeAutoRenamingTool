...
public interface MixinConfig extends MixinSourceSetConfig {
	...
	/**
	 * Helper method for configuring the generated mappings task.
	 * The task will merge the input mappings, and the extra mappings generated by the Mixin AnnotationProcessor by default.
	 */
	default TaskProvider<MergeMappings> generatedMappings(Action<? super MergeMappings> action) {
		getGeneratedMappings().configure(action);
		return getGeneratedMappings();
	}
